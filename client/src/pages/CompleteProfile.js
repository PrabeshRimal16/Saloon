      ...
      if (!form.name || !form.name.trim()) {
        ...
        export default function CompleteProfile() {
          ...
          const getPasswordStrength = (pw) => {
            ...
            if (pw.length < 10) return { label: "MEDIUM", color: 'bg-amber-400', width: '66%' };
              ...
              <div className="flex min-h-screen flex-col lg:flex-row">
                    ...
                    <form onSubmit={handleSubmit} aria-labelledby="complete-heading" className="space-y-5">
                      ...
                      <div>
                        ...
                        <div className="flex items-end border-b-2 border-gray-200 focus-within:border-amber-600 transition-colors">
                          ...
                          />
                          <button type="button" onClick={() => setShowPassword(!showPassword)} className="pb-3 text-gray-400">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <p className={`text-xs mt-1 text-right font-medium tracking-widest ${strength.label === 'WEAK' ? 'text-red-400' : strength.label === 'MEDIUM' ? 'text-amber-500' : 'text-green-500'}`}>{strength.label}</p>
                  </div>
                </div>
